...
**Note**: This task is **optional** and can be completed later when you create VMs. You don't need to do this now if you don't have any VMs yet. Complete this task whenever you create a new VM that you want to access via hostname.
